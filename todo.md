...
## 텔레그램 봇 공지 안내 텍스트 변경
- [ ] "텔레그램봇으로 공지등록할 수 있습니다" → 삭제

## 출금 안내 텍스트 변경
- [x] 출금 설명: BNB체인 중심 설명 추가 (FAQ DB 업데이트 완료, 6개 언어)

## Footer 면책조항 + infoweb4 링크
- [ ] "본 사이트는 프로젝트에서 제공하는 자료를 중심으로 분석 및 구성된 내용을 중심으로 제공됩니다. 모든 법적 및 투자 책임은 당사자들에게 있습니다."
- [ ] "infoweb4를 통해 프로젝트 등록하기" 버튼 → addinfo.infoweb4.vip 연결
