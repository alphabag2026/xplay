...
const LEADER_I18N: Record<string, Record<string, string>> = {
  ...
  "leader.subtitle": { ko: "최대 $100,000 USD 최다 보상! 뛰어난 리더를 추천해주세요", en: "Up to $100,000 USD top reward! Recommend outstanding leaders", zh: "最高$100,000美元最多奖励！推荐优秀领袖", ja: "最大$100,000 USD最多報酬！優れたリーダーを推薦してください", vi: "Phần thưởng lên đến $100,000 USD! Giới thiệu nhà lãnh đạo xuất sắc", th: "รางวัลสูงสุด $100,000 USD! แนะนำผู้นำที่โดดเด่น" },
  ...
  "leader.reward1": { ko: "최대 $100,000", en: "Up to $100,000", zh: "最高$100,000", ja: "最大$100,000", vi: "Lên đến $100,000", th: "สูงสุด $100,000" },
  "leader.reward1Desc": { ko: "USD 최다 보상", en: "USD Top Reward", zh: "美元最多奖励", ja: "USD最多報酬", vi: "USD Phần thưởng cao nhất", th: "รางวัลสูงสุด USD" },
